...
export const paginatedBetsAtom = (input: PaginatedBetInput) =>
  appHttpApiAtom(
    Effect.gen(function* getAllPaginatedBetsEffect() {
      ...
      return yield* client.bet.getAllPaginated({ payload: input });
    })
  );
